...
import { CodingExerciseAgent } from './coding-exercise-agent';
...
export default new ContainerModule(bind => {
    ...
    bind(CodingExerciseAgent).toSelf().inSingletonScope;
    ...
    bind(Agent).toService(CodingExerciseAgent);
    bind(ChatAgent).toService(CodingExerciseAgent);
});
